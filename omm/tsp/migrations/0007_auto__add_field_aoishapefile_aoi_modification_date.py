...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AOIShapefile.aoi_modification_date'
        db.add_column('tsp_aoishapefile', 'aoi_modification_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AOIShapefile.aoi_modification_date'
        db.delete_column('tsp_aoishapefile', 'aoi_modification_date')
