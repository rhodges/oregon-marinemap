...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AOIDesignation'
        db.create_table('tsp_aoidesignation', (
        ...
        db.send_create_signal('tsp', ['AOIDesignation'])

        # Deleting field 'AOIArray.supportfile1'
        db.delete_column('tsp_aoiarray', 'supportfile1')

        # Deleting field 'AOIArray.description'
        db.delete_column('tsp_aoiarray', 'description')

        # Deleting field 'AOIArray.supportfile2'
        db.delete_column('tsp_aoiarray', 'supportfile2')

        # Adding field 'AOIArray.content_type'
        db.add_column('tsp_aoiarray', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tsp_aoiarray_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'AOIArray.object_id'
        db.add_column('tsp_aoiarray', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'AOIArray.name'
        db.alter_column('tsp_aoiarray', 'name', self.gf('django.db.models.fields.CharField')(max_length='255'))

        # Changing field 'AOI.designation'
        db.alter_column('tsp_aoi', 'designation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tsp.AOIDesignation'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'AOIDesignation'
        db.delete_table('tsp_aoidesignation')

        # Adding field 'AOIArray.supportfile1'
        db.add_column('tsp_aoiarray', 'supportfile1', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'AOIArray.description'
        db.add_column('tsp_aoiarray', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'AOIArray.supportfile2'
        db.add_column('tsp_aoiarray', 'supportfile2', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'AOIArray.content_type'
        db.delete_column('tsp_aoiarray', 'content_type_id')

        # Deleting field 'AOIArray.object_id'
        db.delete_column('tsp_aoiarray', 'object_id')

        # Changing field 'AOIArray.name'
        db.alter_column('tsp_aoiarray', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AOI.designation'
        db.alter_column('tsp_aoi', 'designation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpa.MpaDesignation'], null=True))
