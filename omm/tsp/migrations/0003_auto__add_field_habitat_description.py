...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Habitat.description'
        db.add_column('tsp_habitat', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Habitat.description'
        db.delete_column('tsp_habitat', 'description')
