...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserKml.priority'
        db.delete_column('tsp_userkml', 'priority')

        # Deleting field 'AOI.designation'
        db.delete_column('tsp_aoi', 'designation_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('tsp_aoidesignation', (
            ...
            ('acronym', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('tsp', ['AOIDesignation'])

        # Adding field 'UserKml.priority'
        db.add_column('tsp_userkml', 'priority', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'AOI.designation'
        db.add_column('tsp_aoi', 'designation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tsp.AOIDesignation'], null=True, blank=True), keep_default=False)
