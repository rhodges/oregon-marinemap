...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AOIShapefile'
        db.create_table('tsp_aoishapefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=99999, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('aoi', self.gf('django.db.models.fields.related.OneToOneField')(related_name='aoi', unique=True, to=orm['tsp.AOI'])),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('tsp', ['AOIShapefile'])


    def backwards(self, orm):
        
        # Deleting model 'AOIShapefile'
        db.delete_table('tsp_aoishapefile')
