...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AOIShapefile.group'
        db.add_column('tsp_aoishapefile', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tsp.AOIArray'], null=True, blank=True), keep_default=False)

        # Adding field 'AOIShapefile.group_name'
        db.add_column('tsp_aoishapefile', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AOIShapefile.group'
        db.delete_column('tsp_aoishapefile', 'group_id')

        # Deleting field 'AOIShapefile.group_name'
        db.delete_column('tsp_aoishapefile', 'group_name')
