...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AOI.manipulators'
        db.add_column('tsp_aoi', 'manipulators', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AOI.manipulators'
        db.delete_column('tsp_aoi', 'manipulators')
