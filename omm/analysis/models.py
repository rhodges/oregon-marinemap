...
class SeabirdColonies(models.Model):
    ...
    cen_notes = models.CharField(max_length=254)
    spnotes = models.CharField(max_length=254)
    ...
    photo_inte = models.CharField(max_length=150)
...
class Habitats(models.Model):
    ...
    lithology = models.CharField(max_length=19)
    lithology2 = models.CharField(max_length=20)
