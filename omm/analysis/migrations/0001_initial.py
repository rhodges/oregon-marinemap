...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('analysis_islands', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, db_column='NameNOAA', null=True, blank=True)),
            ('objectid', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('islandno', self.gf('django.db.models.fields.CharField')(max_length=10, db_column='ISLANDNO', null=True, blank=True)),
