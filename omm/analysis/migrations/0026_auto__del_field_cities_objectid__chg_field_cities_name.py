...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cities.objectid'
        db.delete_column('analysis_cities', 'objectid')

        # Changing field 'Cities.name'
        db.alter_column('analysis_cities', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Adding field 'Cities.objectid'
        db.add_column('analysis_cities', 'objectid', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Changing field 'Cities.name'
        db.alter_column('analysis_cities', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
