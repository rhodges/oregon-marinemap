...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('analysis_conservationareas', 'area_name', 'name')
        db.rename_column('analysis_outfalls', 'common_nam', 'name')
        db.rename_column('analysis_publicaccess', 'loc', 'name')
    
    
    def backwards(self, orm):
        db.rename_column('analysis_publicaccess', 'name', 'loc')
        db.rename_column('analysis_outfalls', 'name', 'common_nam')
        db.rename_column('analysis_conservationareas', 'name', 'area_name')
