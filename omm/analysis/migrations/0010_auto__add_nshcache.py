...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NSHCache'
        db.create_table('analysis_nshcache', (
            ('nsh', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tsp.AOI'])),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cache', self.gf('picklefield.fields.PickledObjectField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wkt_hash', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('analysis', ['NSHCache'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'NSHCache'
        db.delete_table('analysis_nshcache')
    ...
    models = {
        ...
        'analysis.nshcache': {
            ...
            'cache': ('picklefield.fields.PickledObjectField', [], {}),
