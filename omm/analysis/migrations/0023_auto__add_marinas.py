...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Marinas'
        db.create_table('analysis_marinas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=109)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=53, null=True, blank=True)),
            ('county', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('countyfips', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True)),
            ('town', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('waterway', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('port_name', self.gf('django.db.models.fields.CharField')(max_length=61)),
            ('mile', self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True)),
            ('bank', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True)),
            ('latdec', self.gf('django.db.models.fields.FloatField')()),
            ('long_dec', self.gf('django.db.models.fields.FloatField')()),
            ('operator1', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ('owner', self.gf('django.db.models.fields.CharField')(max_length=113)),
            ('purpose', self.gf('django.db.models.fields.CharField')(max_length=247)),
            ('rwy_conn', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('portseries', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('seqno', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('loc_cd', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('pwdno', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('oldpwd', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('dockcd', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('ndccode', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('cngdst', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True)),
            ('commodity1', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True)),
            ('commodity2', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True)),
            ('commodity3', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True)),
            ('commodity4', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True)),
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('datum', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('depth1', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('depth1a', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('depth2', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('depth2a', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('depth3', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('depth3a', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('totberth1', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('totberth2', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('totberth3', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('mapno', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('firstname', self.gf('django.db.models.fields.CharField')(max_length=21, null=True, blank=True)),
            ('lastname', self.gf('django.db.models.fields.CharField')(max_length=33, null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True)),
            ('fax', self.gf('django.db.models.fields.CharField')(max_length=22, null=True, blank=True)),
        ...
        db.send_create_signal('analysis', ['Marinas'])


    def backwards(self, orm):
        
        # Deleting model 'Marinas'
        db.delete_table('analysis_marinas')
    ...
    models = {
        ...
        'analysis.marinas': {
            ...
            'datum': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            ...
            'mapno': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
