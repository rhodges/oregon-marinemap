...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GeologicalHabitat'
        db.create_table('analysis_geologicalhabitat', (
        ...
        db.send_create_signal('analysis', ['GeologicalHabitat'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'GeologicalHabitat'
        db.delete_table('analysis_geologicalhabitat')
