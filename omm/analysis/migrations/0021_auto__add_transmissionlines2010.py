...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TransmissionLines2010'
        db.create_table('analysis_transmissionlines2010', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('kv', self.gf('django.db.models.fields.FloatField')()),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('owner', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal('analysis', ['TransmissionLines2010'])


    def backwards(self, orm):
        
        # Deleting model 'TransmissionLines2010'
        db.delete_table('analysis_transmissionlines2010')
