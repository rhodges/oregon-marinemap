...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Marinas.datum'
        db.alter_column('analysis_marinas', 'datum', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Marinas.mapno'
        db.alter_column('analysis_marinas', 'mapno', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Marinas.owner'
        db.alter_column('analysis_marinas', 'owner', self.gf('django.db.models.fields.CharField')(max_length=113, null=True))

        # Changing field 'Marinas.state'
        db.alter_column('analysis_marinas', 'state', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Changing field 'Marinas.ndccode'
        db.alter_column('analysis_marinas', 'ndccode', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))


    def backwards(self, orm):
        
        # Changing field 'Marinas.datum'
        db.alter_column('analysis_marinas', 'datum', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Marinas.mapno'
        db.alter_column('analysis_marinas', 'mapno', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Marinas.owner'
        db.alter_column('analysis_marinas', 'owner', self.gf('django.db.models.fields.CharField')(max_length=113))

        # Changing field 'Marinas.state'
        db.alter_column('analysis_marinas', 'state', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'Marinas.ndccode'
        db.alter_column('analysis_marinas', 'ndccode', self.gf('django.db.models.fields.CharField')(max_length=12))
