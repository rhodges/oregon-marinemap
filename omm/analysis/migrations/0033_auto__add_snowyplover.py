...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SnowyPlover'
        db.create_table('analysis_snowyplover', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('cname', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sname', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('spp_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('org_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('unit_num', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('subunit', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ...
        db.send_create_signal('analysis', ['SnowyPlover'])


    def backwards(self, orm):
        
        # Deleting model 'SnowyPlover'
        db.delete_table('analysis_snowyplover')
