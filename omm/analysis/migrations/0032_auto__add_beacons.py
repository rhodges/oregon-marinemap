...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Beacons'
        db.create_table('analysis_beacons', (
            ...
            ('id_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('catcam', self.gf('django.db.models.fields.IntegerField')()),
            ('catlam', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('conrad', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('bcnshp', self.gf('django.db.models.fields.IntegerField')()),
            ('condtn', self.gf('django.db.models.fields.IntegerField')()),
            ('convis', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('beacon_typ', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=99999, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['Beacons'])


    def backwards(self, orm):
        
        # Deleting model 'Beacons'
        db.delete_table('analysis_beacons')
