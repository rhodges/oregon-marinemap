...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Bathymetry'
        db.create_table('analysis_bathymetry', (
        ...
        db.send_create_signal('analysis', ['Bathymetry'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Bathymetry'
        db.delete_table('analysis_bathymetry')
