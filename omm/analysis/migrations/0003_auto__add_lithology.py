...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Lithology'
        db.create_table('analysis_lithology', (
            ('lith_inter', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
            ('lithology', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.send_create_signal('analysis', ['Lithology'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Lithology'
        db.delete_table('analysis_lithology')
