...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Viewsheds'
        db.create_table('analysis_viewsheds', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.FloatField')()),
            ('perimeter', self.gf('django.db.models.fields.FloatField')()),
            ('viewshed', self.gf('django.db.models.fields.FloatField')()),
            ('viewshed_i', self.gf('django.db.models.fields.FloatField')()),
            ('inside', self.gf('django.db.models.fields.FloatField')()),
            ('major1', self.gf('django.db.models.fields.IntegerField')()),
            ('minor1', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('analysis', ['Viewsheds'])


    def backwards(self, orm):
        
        # Deleting model 'Viewsheds'
        db.delete_table('analysis_viewsheds')
