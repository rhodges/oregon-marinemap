...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SturgeonCoastal'
        db.create_table('analysis_sturgeoncoastal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('exclude', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('sqmiles', self.gf('django.db.models.fields.FloatField')()),
            ('conservati', self.gf('django.db.models.fields.CharField')(max_length=28)),
            ('specificar', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ...
        db.send_create_signal('analysis', ['SturgeonCoastal'])


    def backwards(self, orm):
        
        # Deleting model 'SturgeonCoastal'
        db.delete_table('analysis_sturgeoncoastal')
