...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaveEnergyPermits.label'
        db.delete_column('analysis_waveenergypermits', 'label')
    
    
    def backwards(self, orm):
        
        # Adding field 'WaveEnergyPermits.label'
        db.add_column('analysis_waveenergypermits', 'label', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
