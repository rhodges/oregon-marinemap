...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TransmissionLines1993'
        db.create_table('analysis_transmissionlines1993', (
            ...
            ('orpower', self.gf('django.db.models.fields.FloatField')()),
            ('orpower_id', self.gf('django.db.models.fields.FloatField')()),
            ('fename', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ...
            ('edit_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('analysis', ['TransmissionLines1993'])


    def backwards(self, orm):
        
        # Deleting model 'TransmissionLines1993'
        db.delete_table('analysis_transmissionlines1993')
