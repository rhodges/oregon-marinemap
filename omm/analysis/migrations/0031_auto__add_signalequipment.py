...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SignalEquipment'
        db.create_table('analysis_signalequipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inform', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('objnam', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('recdat', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('recind', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('sordat', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('sorind', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('scamax', self.gf('django.db.models.fields.IntegerField')()),
            ('scamin', self.gf('django.db.models.fields.IntegerField')()),
            ('txtdsc', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('ninfom', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('nobjnm', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('ntxtds', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('lnam', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('rver', self.gf('django.db.models.fields.IntegerField')()),
            ('ruin', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('grup', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('catfog', self.gf('django.db.models.fields.IntegerField')()),
            ('catlit', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('catsit', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('catsiw', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('catspm', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('colour', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('colpat', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('comcha', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('datend', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('datsta', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('elevat', self.gf('django.db.models.fields.FloatField')()),
            ('exclit', self.gf('django.db.models.fields.FloatField')()),
            ('height', self.gf('django.db.models.fields.FloatField')()),
            ('litchr', self.gf('django.db.models.fields.IntegerField')()),
            ('litvis', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('marsys', self.gf('django.db.models.fields.IntegerField')()),
            ('mltylt', self.gf('django.db.models.fields.IntegerField')()),
            ('natcon', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('orient', self.gf('django.db.models.fields.FloatField')()),
            ('perend', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('persta', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('picrep', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('sectr1', self.gf('django.db.models.fields.FloatField')()),
            ('sectr2', self.gf('django.db.models.fields.FloatField')()),
            ('sigfrq', self.gf('django.db.models.fields.IntegerField')()),
            ('siggen', self.gf('django.db.models.fields.IntegerField')()),
            ('siggrp', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('sigper', self.gf('django.db.models.fields.FloatField')()),
            ('sigseq', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('topshp', self.gf('django.db.models.fields.IntegerField')()),
            ('valnmr', self.gf('django.db.models.fields.FloatField')()),
            ('valmxr', self.gf('django.db.models.fields.FloatField')()),
            ('veracc', self.gf('django.db.models.fields.FloatField')()),
            ('verdat', self.gf('django.db.models.fields.IntegerField')()),
            ('verlen', self.gf('django.db.models.fields.FloatField')()),
            ('light_type', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=99999, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['SignalEquipment'])


    def backwards(self, orm):
        
        # Deleting model 'SignalEquipment'
        db.delete_table('analysis_signalequipment')
