...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StateParks.objectid'
        db.delete_column('analysis_stateparks', 'objectid')

        # Adding field 'StateParks.gisacres'
        db.add_column('analysis_stateparks', 'gisacres', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StateParks.objectid'
        db.add_column('analysis_stateparks', 'objectid', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Deleting field 'StateParks.gisacres'
        db.delete_column('analysis_stateparks', 'gisacres')
