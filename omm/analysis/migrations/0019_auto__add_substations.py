...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Substations'
        db.create_table('analysis_substations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objectid', self.gf('django.db.models.fields.IntegerField')()),
            ('sta_code', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ...
        db.send_create_signal('analysis', ['Substations'])


    def backwards(self, orm):
        
        # Deleting model 'Substations'
        db.delete_table('analysis_substations')
