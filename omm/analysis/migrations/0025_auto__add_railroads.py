...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Railroads'
        db.create_table('analysis_railroads', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fraarcid', self.gf('django.db.models.fields.IntegerField')()),
            ('miles', self.gf('django.db.models.fields.FloatField')()),
            ('stateab', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('statefips', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('cntyfips', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('stcntyfips', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('fraregion', self.gf('django.db.models.fields.IntegerField')()),
            ('rrowner1', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('rrowner2', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('rrowner3', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts1', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts2', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts3', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts4', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts5', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts6', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts7', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts8', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('trkrghts9', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('stracnet', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('sigsys', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('tracks', self.gf('django.db.models.fields.IntegerField')()),
            ('frfranode', self.gf('django.db.models.fields.IntegerField')()),
            ('tofranode', self.gf('django.db.models.fields.IntegerField')()),
            ('net', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('passngr', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('den07code', self.gf('django.db.models.fields.IntegerField')()),
            ('yards', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('subdiv', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.send_create_signal('analysis', ['Railroads'])


    def backwards(self, orm):
        
        # Deleting model 'Railroads'
        db.delete_table('analysis_railroads')
