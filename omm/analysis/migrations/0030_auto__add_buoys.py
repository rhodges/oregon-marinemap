...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Buoys'
        db.create_table('analysis_buoys', (
            ...
            ('colour', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ...
            ('boyshp', self.gf('django.db.models.fields.IntegerField')()),
            ('catinb', self.gf('django.db.models.fields.IntegerField')()),
            ('prodct', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('buoy_type', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=99999, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['Buoys'])


    def backwards(self, orm):
        
        # Deleting model 'Buoys'
        db.delete_table('analysis_buoys')
