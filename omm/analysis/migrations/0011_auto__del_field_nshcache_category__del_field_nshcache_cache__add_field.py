...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NSHCache.category'
        db.delete_column('analysis_nshcache', 'category')

        # Deleting field 'NSHCache.cache'
        db.delete_column('analysis_nshcache', 'cache')

        # Adding field 'NSHCache.type'
        db.add_column('analysis_nshcache', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'NSHCache.context'
        db.add_column('analysis_nshcache', 'context', self.gf('picklefield.fields.PickledObjectField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'NSHCache.category'
        db.add_column('analysis_nshcache', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'NSHCache.cache'
        db.add_column('analysis_nshcache', 'cache', self.gf('picklefield.fields.PickledObjectField')(default=''), keep_default=False)

        # Deleting field 'NSHCache.type'
        db.delete_column('analysis_nshcache', 'type')

        # Deleting field 'NSHCache.context'
        db.delete_column('analysis_nshcache', 'context')
    ...
    models = {
        ...
        'analysis.nshcache': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nsh': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tsp.AOI']"}),
