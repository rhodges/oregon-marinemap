...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NSHCache.nsh'
        db.delete_column('analysis_nshcache', 'nsh_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'NSHCache.nsh'
        db.add_column('analysis_nshcache', 'nsh', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['tsp.AOI']), keep_default=False)
