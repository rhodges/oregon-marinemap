...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StateParks.full_name'
        db.alter_column('analysis_stateparks', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'StateParks.full_name'
        db.alter_column('analysis_stateparks', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=100))
