...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SturgeonEstuaries'
        db.create_table('analysis_sturgeonestuaries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('cv', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('area', self.gf('django.db.models.fields.IntegerField')()),
            ('exclude', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('sqmiles', self.gf('django.db.models.fields.FloatField')()),
            ('sqkm', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('analysis', ['SturgeonEstuaries'])


    def backwards(self, orm):
        
        # Deleting model 'SturgeonEstuaries'
        db.delete_table('analysis_sturgeonestuaries')
