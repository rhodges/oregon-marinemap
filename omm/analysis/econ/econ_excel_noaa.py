...
def add_footnotes(ws, row):
    ...
    ws.write(row+2, 0, '2. Estimated economic output (EEO) is a measure of the total direct and indirect economic activity associated with sales or expenditures in a certain sector, multipliers provided by personal communication with NOAA.', notes_style)
